...
expressApp.use('/interaction', express.static(path.join(__dirname, 'public')));
expressApp.use(
  '/interaction/:uid',
...
// https://obscure-oasis-20527.herokuapp.com/auth?client_id=foo&response_type=code&redirect_uri=https%3A%2F%2Fjwt.io&scope=openid%20email
